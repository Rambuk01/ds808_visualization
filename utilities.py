...
listing_columns = [
    ...
    # 'amenities', # Wordcloud!
    # per night... probably goes lower, if people rent for a week or more.
    'price',
    # 'minimum_nights',
    # 'maximum_nights',
...
{'points': [
    {
        ...
        'pointIndex': 5, 
        'location': 1, 
        'z': 1684.6401291016675, 
        'hovertext': 'Indre By',
        'bbox': {
            'x0': 800.4574736664147, 
            'x1': 800.4574736664147, 
            'y0': 204.28856844932605, 
            'y1': 204.28856844932605
            }
        }
    ]
}
